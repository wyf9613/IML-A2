...
Ridge & Standard & 2444.76 & 0.9212 \\
Ridge & Min--max & 2442.11 & 0.9214 \\
...
Overall, the evaluation supports the main research question, showing that vehicle attributes can predict used-car prices with high accuracy. The best-performing model was Random Forest, which explained about 95.7\% of the variance in the held-out test set on the original price scale. It also achieved a lower prediction error than all baseline and neural network models.
